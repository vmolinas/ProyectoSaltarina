...
func _ready():
	...
	acel_caida_original = aceleracion_caida
...
func _on_EnfriamientoPowerUpVolar_timeout():
	...
	aceleracion_caida = acel_caida_original
...
func play_entrar_portal(posicion_portal):
	...
	$Tween.interpolate_property(self, "global_position", global_position,
		posicion_portal, 0.8, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.start()
